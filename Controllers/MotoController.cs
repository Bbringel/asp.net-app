...
namespace MvcMoto.Controllers
{
    public class MotoController : Controller
    {
        ...
        public MotoController(MvcMotoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            var motors = from m in _context.Moto
                         select m;

            if (!String.IsNullOrEmpty(searchString))
            {
                motors = motors.Where(s => s.Name!.Contains(searchString));
            }

            return View(await motors.ToListAsync());
        }
